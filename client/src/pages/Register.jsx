...
const Register = () => {
  ...
  const switchTab = (tab) => {
    setActiveTab(tab);
    setFormData({ ...formData, role: tab, registerNumber: '', block: '', department: '', staffId: '', staffSecret: '' });
    setErrors({});
  };
              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="flex bg-white/50 p-1 rounded-2xl mb-6 border border-white">
                  <button
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-xl text-xs font-bold transition-all ${activeTab === 'STUDENT'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-xl text-xs font-bold transition-all ${activeTab === 'STAFF'
                        ? 'bg-white shadow-sm text-slate-900'
                        : 'text-slate-600 hover:text-slate-900'
                      }`}
                  >
